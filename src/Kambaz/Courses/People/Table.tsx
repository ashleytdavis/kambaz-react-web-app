            ...
            <Table striped>
                ...
                <tbody>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-login-id">002134547</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2024-11-01</td>
                        <td className="wd-total-activity">1:21:02</td></tr>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-last-activity">2023-21-01</td>
                        <td className="wd-total-activity">6:21:02</td></tr>

                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        <span className="wd-first-name">Natasha</span>{" "}
                        <span className="wd-last-name">Romanoff</span></td>
                        <td className="wd-login-id">002567532</td>
                        <td className="wd-section">S103</td>
                        <td className="wd-role">PROFESSOR</td>
                        <td className="wd-last-activity">2025-01-01</td>
                        <td className="wd-total-activity">100:21:02</td></tr>
                </tbody>
            </Table>
        </div>);
}
